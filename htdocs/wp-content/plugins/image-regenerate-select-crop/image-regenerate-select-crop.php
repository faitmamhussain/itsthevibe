...
class SIRSC_Image_Regenerate_Select_Crop
{
	...
	function load_assets( $hook_suffix = '' ) {
		...
		wp_enqueue_style( 'sirsc-style', plugins_url( '/assets/css/style.css', __FILE__ ), array(), '20150312', false );
		wp_register_script( 'sirsc-custom-js', plugins_url( '/assets/js/custom.js', __FILE__ ), array(), '20150312' );
