...
spAdConfig = {
    slots: [
        ...
        /*Other RR*/
        {
            ...
            isMobile: false,
            adZones: [SP_OBJ.SESSION.PAGE_TYPES["category"], SP_OBJ.SESSION.PAGE_TYPES["gallery"], SP_OBJ.SESSION.PAGE_TYPES["end-gallery"], SP_OBJ.SESSION.PAGE_TYPES["404"]],
            bidProviders: arrayUnion(["aol"], enabledProviders)
        },
        {
        ...
        //these ones are not needed, we will load them by AJAX, so unique names are required
        /*{
            name: '/122041498/YDD_InPost_Ad_Bottom',
            sizes: [[320, 50],[320, 100],[300, 250]],
            elementId: 'div-gpt-ad-1432516825682-9',
            isMobile: true,
            adZones: ["article", "gallery"],
            bidProviders: arrayUnion(["aol"], enabledProviders)
        },
        {
            name: '/122041498/YDD_InPost_Ad_Bottom',
